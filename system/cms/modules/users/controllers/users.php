...
class Users extends Public_Controller
{
	...
	public function login()
	{
		...
		if ($this->form_validation->run() or $this->current_user)
		{
			...
			if($this->input->post('driver')) {
				redirect('http://localhost/getaride/drivers-home');
			}
	...
	public function user_ride() {
		$this->user_m->user_add_ride($this->input->post('start_location'),$this->input->post('destination_location'),$this->input->post('lat'),$this->input->post('lng'));
	}

	public function get_flag() {
		$vehicle_id = $this->user_m->get_flag();
		echo $vehicle_id;
	}

	public function start_ride() {
		$this->user_m->start_ride($this->input->post('vehicle_id'));
	}

	public function end_ride() {
		$this->user_m->end_ride();
	}

	public function save_rating() {
		$this->user_m->save_rating($this->input->post('rating'));
	}

	public function save_feedback() {
		$this->user_m->save_feedback($this->input->post('feedback'));
	}

	public function bookings() {
		echo $this->user_m->bookings();
	}

	public function earnings() {
		echo $this->user_m->earnings();
	}
}
